...
mix.styles([
    ...
    'resources/public/css/slippry.css',
    'resources/public/css/fonts.css',
    'resources/public/css/style.css',
], 'public/css/front.css');

mix.scripts([
    'resources/public/js/jquery-1.12.4.min.js',
    'resources/public/js/slippry.js',
    'resources/public/js/main.js',
    'resources/public/js/jquery.instagramFeed.min.js',
], 'public/js/front.js');

mix.copy('resources/public/img', 'public/img');
mix.copy('resources/public/css/fonts', 'public/css/fonts');
